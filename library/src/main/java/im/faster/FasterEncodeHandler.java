...
public class FasterEncodeHandler extends Handler {
    ...
    private WeakReference<FasterEncodeListener> mWeakListener;

    public FasterEncodeHandler(FasterEncodeListener listener) {
    ...
    public void handleMessage(Message msg) {
        FasterEncodeListener listener = mWeakListener.get();
        if (listener == null) {
            return;
        }
    ...
    public interface FasterEncodeListener {
