 ...
 */
public class FasterCameraView extends GLSurfaceView implements GLSurfaceView.Renderer {
    ...
    public FasterCameraView(Context context) {
        this(context, null);
    }

    public FasterCameraView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public boolean startCamera() {
        ...
        int[] range = adaptFpsRange(FasterEncoder.VFPS, params.getSupportedPreviewFpsRange());
