...
public class FasterRecordHandler extends Handler {
    ...
    private WeakReference<FasterRecordListener> mWeakListener;

    public FasterRecordHandler(FasterRecordListener listener) {
    ...
    public void handleMessage(Message msg) {
        FasterRecordListener listener = mWeakListener.get();
        if (listener == null) {
            return;
        }
    ...
    public interface FasterRecordListener {
