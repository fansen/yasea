...
public final class FasterAllocator {
     ...
     */
    public FasterAllocator(int individualAllocationSize) {
     ...
     */
    public FasterAllocator(int individualAllocationSize, int initialAllocationCount) {
